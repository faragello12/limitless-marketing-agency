...
export default function SocialMediaMarketing() {
  ...
  const offers = [
    ...
    "Account Management",
    "Analytics & Reporting",
    "Platform-Specific Growth Plans"
  ];

  const whoFor = [
    "Startups launching brand presence",
    "Public figures growing communities",
    "Brands ready to scale through organic media"
  ];
            ...
            >
              {whoFor.map((item) => (
                <motion.article
                  ...
                  className="group rounded-[2rem] border border-white/10 bg-[#222222] p-6 transition duration-500 hover:border-gold/45 hover:shadow-glow sm:p-8"
                >
                  <p className="text-lg text-white/70 md:text-xl">{item}</p>
                </motion.article>
              ))}
            </motion.div>
          </div>
